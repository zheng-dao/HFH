...
const handler = async (app) => {
  const adminSummary = [
    {
      title: 'Name',
      value: app.application?.AssignedTo ? humanName(app.application.AssignedTo) : 'Unknown',
    },
    {
      title: 'Job Title',
  ...
  const liaisonSummary = [
    {
      title: 'Name',
      value: app.application?.User ? humanName(app.application.User) : 'Unknown',
    },
    {
      title: 'Job Title',
  ...
  serviceMemberSummary.push(
    ...
    },
    {
      ...
      value: app.application?.ServiceMember?.other_patient
        ? ''
