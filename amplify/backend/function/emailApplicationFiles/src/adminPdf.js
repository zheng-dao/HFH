...
const handler = async app => {
  ...
  const adminSummary = [{
    title: 'Name',
    value: (_app$application = app.application) !== null && _app$application !== void 0 && _app$application.AssignedTo ? (0, _humanName.default)(app.application.AssignedTo) : 'Unknown'
  }, {
    title: 'Job Title',
  ...
  const liaisonSummary = [{
    title: 'Name',
    value: (_app$application9 = app.application) !== null && _app$application9 !== void 0 && _app$application9.User ? (0, _humanName.default)(app.application.User) : 'Unknown'
  }, {
    title: 'Job Title',
  ...
  }, "Administrator Application Summary")), /*#__PURE__*/_react.default.createElement(_renderer.View, {
