...
exports.handler = async (event) => {
  ...
  const messageTemplate = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
        ...
        <tr>
            ...
            <p style="text-align: left; margin: 0 1em 3em 1em;">${body.name} submitted as exception the initial stay (${body.dates}).</p>
  ...
  var eParams = {
    ...
    Message: {
      ...
      Subject: {
        Data: 'Initial Stay' + ' Submitted as Exception for ' + body.service_member_name,
      },
    },
