...
exports.handler = async event => {
  ...
  const messageTemplate = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
        ...
        <title>New Hotels for Heroes Application</title>
        </head>
        ...
        <tr>
            ...
            <p style="text-align: left; margin: 0 1em 3em 1em;">${body.name} submitted as requested the ${body.initial ? 'initial stay' : 'extended stay'} (${body.dates}).</p>
  ...
  var eParams = {
    ...
    Message: {
      ...
      Subject: {
        Data: (body.initial ? 'Initial Stay' : 'Extended Stay') + ' Submitted as Requested for ' + body.service_member_name
      }
    },
