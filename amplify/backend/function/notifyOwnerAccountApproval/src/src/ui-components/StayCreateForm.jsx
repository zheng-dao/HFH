...
export default function StayCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setReservation_number(initialValues.reservation_number);
    setPayment_type(initialValues.payment_type);
    setPayment_points_used(initialValues.payment_points_used);
    setPayment_cost_of_reservation(initialValues.payment_cost_of_reservation);
    setCheckout_points_used(initialValues.checkout_points_used);
    setCheckout_cost_of_reservation(initialValues.checkout_cost_of_reservation);
    setRequested_check_in(initialValues.requested_check_in);
    setRequested_check_out(initialValues.requested_check_out);
    setStatus(initialValues.status);
    setActual_check_in(initialValues.actual_check_in);
    setActual_check_out(initialValues.actual_check_out);
    setGuest_stayed_at_hotel(initialValues.guest_stayed_at_hotel);
    setReason_guest_did_not_stay(initialValues.reason_guest_did_not_stay);
    setPayment_incidental_cost(initialValues.payment_incidental_cost);
    setCharge_type(initialValues.charge_type);
    setCard(initialValues.card);
    setNote(initialValues.note);
    setReconciled(initialValues.reconciled);
    setReady_for_final_reconcile(initialValues.ready_for_final_reconcile);
    setComment(initialValues.comment);
    setComparable_cost(initialValues.comparable_cost);
    setCertificate_number(initialValues.certificate_number);
    setConfirmation_number(initialValues.confirmation_number);
    setCard_used_for_incidentals(initialValues.card_used_for_incidentals);
    setRoom_type_requests(initialValues.room_type_requests);
    setRoom_feature_requests(initialValues.room_feature_requests);
    setCurrentRoom_feature_requestsValue(undefined);
    setRoom_type_actual(initialValues.room_type_actual);
    setRoom_feature_actual(initialValues.room_feature_actual);
    setCurrentRoom_feature_actualValue(undefined);
    setRoom_description(initialValues.room_description);
    setReason_decline(initialValues.reason_decline);
    setReason_return(initialValues.reason_return);
    setCharge_reconcile(initialValues.charge_reconcile);
    setHotel_reconcile(initialValues.hotel_reconcile);
    setPoints_reconcile(initialValues.points_reconcile);
    setGiftcard_reconcile(initialValues.giftcard_reconcile);
    setBatch_no(initialValues.batch_no);
    setCity(initialValues.city);
    setNarrative(initialValues.narrative);
    setSpecial_requests(initialValues.special_requests);
    setErrors({});
  };
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new Stay(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, 'StayCreateForm')}
    >
      <SelectField
        label="Type"
