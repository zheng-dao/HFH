...
export declare type StayUpdateFormInputValues = {
  type?: string;
  state?: string;
...
export declare type StayUpdateFormValidationValues = {
...
export declare type StayUpdateFormOverridesProps = {
  StayUpdateFormGrid?: FormProps<GridProps>;
...
export declare type StayUpdateFormProps = React.PropsWithChildren<
  {
    overrides?: StayUpdateFormOverridesProps | undefined | null;
  } & {
    id?: string;
    stay?: Stay;
    onSubmit?: (fields: StayUpdateFormInputValues) => StayUpdateFormInputValues;
    onSuccess?: (fields: StayUpdateFormInputValues) => void;
    onError?: (fields: StayUpdateFormInputValues, errorMessage: string) => void;
    onCancel?: () => void;
    onChange?: (fields: StayUpdateFormInputValues) => StayUpdateFormInputValues;
    onValidate?: StayUpdateFormValidationValues;
  } & React.CSSProperties
>;
export default function StayUpdateForm(props: StayUpdateFormProps): React.ReactElement;
