...
export declare type ApplicantCreateFormInputValues = {
  first_name?: string;
  last_name?: string;
  email?: string;
  telephone?: string;
...
export declare type ApplicantCreateFormValidationValues = {
...
export declare type ApplicantCreateFormOverridesProps = {
  ApplicantCreateFormGrid?: FormProps<GridProps>;
...
export declare type ApplicantCreateFormProps = React.PropsWithChildren<
  {
    overrides?: ApplicantCreateFormOverridesProps | undefined | null;
  } & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: ApplicantCreateFormInputValues) => ApplicantCreateFormInputValues;
    onSuccess?: (fields: ApplicantCreateFormInputValues) => void;
    onError?: (fields: ApplicantCreateFormInputValues, errorMessage: string) => void;
    onCancel?: () => void;
    onChange?: (fields: ApplicantCreateFormInputValues) => ApplicantCreateFormInputValues;
    onValidate?: ApplicantCreateFormValidationValues;
  } & React.CSSProperties
>;
export default function ApplicantCreateForm(props: ApplicantCreateFormProps): React.ReactElement;
