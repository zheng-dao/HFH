...
export default function ApplicationCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setLiaison_read(initialValues.liaison_read);
    setAdmin_read(initialValues.admin_read);
    setException_narrative(initialValues.exception_narrative);
    setLiaison_terms_of_use_agreement(initialValues.liaison_terms_of_use_agreement);
    setSm_terms_of_use_agreement(initialValues.sm_terms_of_use_agreement);
    setErrors({});
  };
  const validations = {
    status: [],
