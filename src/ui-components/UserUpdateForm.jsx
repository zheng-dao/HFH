...
export default function UserUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setAdmin_approval(cleanValues.admin_approval);
    setExpiration_date(cleanValues.expiration_date);
    setExtension(cleanValues.extension);
    setAffiliation(cleanValues.affiliation);
    setTimezone(cleanValues.timezone);
    setObserves_dst(cleanValues.observes_dst);
    setReceive_emails(cleanValues.receive_emails);
  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        isReadOnly={false}
        type="datetime-local"
        defaultValue={expiration_date && convertToLocal(new Date(expiration_date))}
        onChange={(e) => {
          let { value } = e.target;
          if (onChange) {
            const modelFields = {
